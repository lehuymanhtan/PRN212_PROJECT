...
### 👤 Thành viên 1: Project Manager (PM) kiêm Database Developer
...
### 👤 Thành viên 2: UI/UX Lead kiêm Frontend XAML Coder
...
### 👤 Thành viên 3: Module Quản lý Deadline & Lịch thi
...
### 👤 Thành viên 4: Module Quản lý Tài liệu & PDF Viewer
...
### 👤 Thành viên 5: Module AI Assistant & API Integration
...
### 👤 Thành viên 6: Module Ghi chú (Annotation) & Flashcard
