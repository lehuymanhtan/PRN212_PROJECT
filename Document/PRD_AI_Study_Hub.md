...
- **Quản lý Môn học (Subjects):** Hỗ trợ thêm, sửa, xóa môn học (bao gồm Tên, mã môn, tên giảng viên, số tín chỉ). Mỗi môn học đóng vai trò như một Workspace riêng biệt.
...
- **Giai đoạn 4 (Tích hợp AI & Hoàn thiện):** Kết nối API, làm tính năng bôi đen text -> gọi AI trả về kết quả. Thực hiện Testing, Fix bug và đóng gói phần mềm (.exe).
